...
#include "mjpc/tasks/barrett/barrett.h"
...
namespace mjpc {
std::string Barrett::XmlPath() const {
  return GetModelPath("barrett/task.xml");
}
std::string Barrett::Name() const { return "Barrett"; }
...
// ------------------------------------------
void Barrett::ResidualFn::Residual(const mjModel* model, const mjData* data,
